...
def get_data():
    ...
    cars = []
    with open('../output_images//cars.txt', 'r') as f:
        for fname in f:
            cars.append(fname.rstrip('\n'))
    f.close()

    non_cars = []
    with open('../output_images//non_cars.txt', 'r') as f:
        for fname in f:
...
if __name__=='__main__':
    ...
    pickle.dump(car_features, open('../output_images/car_features.p', 'wb'))
    pickle.dump(noncar_features, open('../output_images/noncar_features.p', 'wb'))
