...
if __name__=='__main__':
    ...
    # Load features data
    car_features = pickle.load(open('../output_images/car_features.p', 'rb'))
    noncar_features = pickle.load(open('../output_images/noncar_features.p', 'rb'))
    ...
    joblib.dump(svc, '../output_images/classifier.pkl')
    pickle.dump(scaler, open('../output_images/scaler.p', 'wb'))
